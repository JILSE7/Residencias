...
const data = [
    ...
    [ //Calor
        [{ key: 'D19', des: 'Metro cuadrado kelvin por watt.' }, { key: 'J19', des: 'Grado fahrenheit hora pie cuadrado por unidad térmica británica (termoquímico).' }, { key: 'J22', des: 'Grado fahrenheit hora pie cuadrado por unidad térmica británica (tabla internacional).' }, { key: 'J83', des: 'Clo (Clo es una unidad de medida empleada para el índice de indumento.)' }, { key: 'L14', des: 'Metro cuadrado hora grado celsius por kilocaloría (tabla internacional)' }],
        [{ key: 'A1', des: '15 ° C calorías' }, { key: 'BTU', des: 'Unidad térmica británica (tabla internacional)' }, { key: 'D70', des: 'Calorías (tabla internacional)' }, { key: 'E14', des: 'Kilocaloría (tabla internacional)' }, { key: 'J39', des: 'Unidad térmica británica (significado)' }, { key: 'J55', des: 'Watt segundo' }, { key: 'J75', des: 'Caloría (Unidad de energía térmica, de símbolo cal…do centígrado la temperatura de 1 gramo de agua.)' }, { key: 'K51', des: 'Kilocaloría (significado)' }, { key: 'K53', des: 'Kilocaloría (termoquímico)' }, { key: 'N66', des: 'Unidad térmica británica (39 °f) (Unidad de energí…ades en una temperatura de referencia de 39 ° F.)' }, { key: 'N67', des: 'Unidad térmica británica (59 °f) (Unidad de energí…ades en una temperatura de referencia de 59 ° F.)' }, { key: 'N68', des: 'Unidad térmica británica (60 °f) (Unidad de energí…ades en una temperatura de referencia de 60 ° F.)' }, { key: 'N69', des: 'Caloría (20 °c) (Unidad para la cantidad de calor,…stándar a nivel del mar, de 19,5 ° C a 20,5 ° C.)' }, { key: 'N70', des: 'Quad (Unidad de energía de acuerdo al sistema imperial de unidades)' }, { key: 'N71', des: 'Termia (energía comercial) (Unidad de energía calo…nidos definida como: 1 thm (EC) = 100 000 BtuIT.)' }, { key: 'N72', des: 'Termia (UEA) (Unidad de energía térmica en uso comercial.)' }],
        [{ key: 'B41', des: 'Kilojoule por kelvin' }, { key: 'J43', des: 'Unidad térmica británica (tabla internacional) por libra grado fahrenheit' }, { key: 'J50', des: 'Unidad térmica británica (termoquímico) por libra grado fahrenheit' }, { key: 'J76', des: 'Caloría (tabla internacional) por gramo gadro celsius' }, { key: 'J79', des: 'Caloría (termoquímico) por gramo gadro celsius' }, { key: 'JE', des: "Joule por kelvin (Es el aumento de entropía de un sistema que recibe una cantidad de calor de 1 joule, a la temperatura termodinámica constante de 1 kelvin, siempre que en el sistema no tenga lugar ninguna transformación irreversible.)" }, { key: 'N60', des: "Unidad térmica británica (tabla internacional) por grado fahrenheit (Unidad de la capacidad calorífica según el sistema Imperial de unidades.)" }, { key: 'N61', des: "Unidad térmica británica (termoquímico) por grado fahrenheit (Unidad de la capacidad calorífica según el sistema Imperial de unidades.)" }, { key: 'N62', des: "Unidad térmica británica (tabla internacional) por grado rankine (Unidad de la capacidad calorífica según el sistema Imperial de unidades.)" }, { key: 'N63', des: 'Unidad térmica británica (termoquímico) por grado …alorífica según el sistema Imperial de unidades.)' }, { key: 'N64', des: 'Unidad térmica británica (termoquímico) por libra …bra según el sistema de avoirdupois de unidades.)' }, { key: 'N65', des: "Kilocaloría (tabla internacional) por gramo kelvin (Unidad de la capacidad calorífica relacionada con la masa como cociente 1000 veces de la caloría (tabla internacional) dividido por el producto de 0,001 veces de las unidades de base kilogramo y kelvin.)" }],
        [{ key: 'A21', des: 'Unidad térmica británica (tabla internacional) por libra grado rankine' }, { key: 'B11', des: 'Joule por kilogramo kelvin (Es la capacidad térmic…ación de temperatura termodinámica de 1 kelvin. )' }, { key: 'B43', des: 'Kilojoule por kilogramo kelvin' }, { key: 'D37', des: 'Calorías (termoquímicas) por gramo de kelvin' }, { key: 'D76', des: 'Calorías (tabla internacional) por gramo de kelvin' }], //capacidad de calor es
        [{ key: 'C91', des: 'Recíprocidad de kelvin ó kelvin a la potencia menos 1' }, { key: 'M20', des: 'Recíproco de megakelvin ó megakelvin a la potencia menos 1' }],
        [{ key: 'C64', des: 'Pascal por kelvin' }, { key: 'F81', des: 'Bar por kelvin' }], //coefi a pre
        [{ key: 'A20', des: 'Unidad térmica británica (tabla internacional) por segundo pie cuadrado grado rankine.' }, { key: 'A23', des: 'Unidad térmica británica (tabla internacional) por hora pie cuadrado grado rankine.' }, { key: 'D39', des: 'Calorías (termoquímicas) por segundo centímetro cuadrado kelvin' }, { key: 'D72', des: 'Calorías (tabla internacional) por segundo centímetro cuadrado kelvin' }, { key: 'N74', des: "Unidad térmica británica (tabla internacional) por hora pie cuadrado grado fahrenheit. (Unidad del coeficiente de transición térmica según el sistema Imperial de unidades.)" }, { key: 'N75', des: "Unidad térmica británica (termoquímico) por hora pie cuadrado grado farenheit. (Unidad del coeficiente de transición térmica según el sistema imperial de unidades.)" }, { key: 'N76', des: "Unidad térmica británica (tabla internacional) por segundo pie cuadrado grado fahrenheit. (Unidad del coeficiente de transición térmica según el sistema imperial de unidades.)" }, { key: 'N77', des: "Unidad térmica británica (termoquímico) por segundo pie cuadrado grado fahrenheit. (Unidad del coeficiente de transición térmica según el sistema imperial de unidades.)" }, { key: 'N78', des: "Kilowatt por metro cuadrado kelvin (1000 veces la unidad derivada watt, dividida por el producto de la potencia de unidad base, metro, por el exponente 2 y la unidad base, kelvin, del sistema internacional de unidades." }],
        [{ key: 'D55', des: 'Watt por metro cuadrado kelvin' }],
        [{ key: 'D52', des: 'Watt por kelvin' }],
        [{ key: 'A22', des: 'Unidad térmica británica (tabla internacional) por segundo pie grado rankine' }, { key: 'D38', des: 'Calorías (termoquímicas) por segundo centímetro kelvin' }, { key: 'D53', des: "Watt por metro kelvin (Es la conductividad térmica de un cuerpo homogéneo isótropo, en la que una diferencia de temperatura de 1 kelvin entre dos planos paralelos, de área 1 metro cuadrado y distantes 1 metro, produce entre estos planos un flujo térmico de 1 watt.)" }, { key: 'D71', des: 'Calorías (tabla internacional) por segundo centímetro kelvin' }, { key: 'J40', des: 'Unidad térmica británica (tabla internacional) pie por hora pie cuadrado grado fahrenheit.' }, { key: 'J41', des: 'Unidad térmica británica (tabla internacional) pulgada por hora pie cuadrado grado fahrenheit.' }, { key: 'J42', des: 'Unidad térmica británica (tabla internacional) pulgada por segundo pie cuadrado grado fahrenheit.' }, { key: 'J46', des: 'Unidad térmica británica (termoquímico) pie por hora pie cuadrado grado fahrenheit.' }, { key: 'J48', des: 'Unidad térmica británica (termoquímico) pulgada por hora pie cuadrado grado fahrenheit.' }, { key: 'J49', des: 'Unidad térmica británica (termoquímico) pulgada por segundo pie cuadrado grado fahrenheit.' }, { key: 'J78', des: 'Caloría (termoquímica) por centímetro segundo grado celsius' }, { key: 'K52', des: 'Kilocaloría (tabla internacional) por hora metro grado celsius' }, { key: 'N80', des: "Watt por metro grado celsius (Unidad derivada del sistema internacional, watt, dividido por el producto de la unidad base, metro, y la unidad de temperatura grados Celsius.)" }, { key: 'N81', des: "Kilowatt por metro kelvin (1000 veces de la unidad derivada, watt, dividido por el producto de la unidad de base metro y la unidad base kelvin, ambas del sistema internacional.)" }, { key: 'N82', des: "Kilowatt por metro grado celsius (1000 veces de la unidad derivada, watt, dividido por el producto de la unidad base metro y la unidad de temperatura grados Celsius.)" }]
        [{ key: 'N58', des: 'Unidad térmica británica (tabla internacional) por…e energía según el sistema Imperial de unidades.)' }, { key: 'N59', des: 'Unidad térmica británica (termoquímica) por pie cú…e energía según el sistema Imperial de unidades.)' }]
        [
